...
## References
- (Parekh et al. 2017) Sanjeel Parekh, Slim Essid, Alexey Ozerov, Ngoc Q. Duong, Patrick Pérez, Gaël Richard. Guiding audio source separation by video object information. In IEEE  Workshop on Applications of Signal Processing to Audio and Acoustics (WASPAA), 2017.
...
- (Keuper et al. 2015) Margret Keuper, Bjoern Andres, Thomas Brox. Motion trajectory segmentation via minimum cost multicuts. In IEEE International Conference on Computer Vision (ICCV), 2015.
